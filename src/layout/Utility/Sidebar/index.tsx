...
const suggestedAccounts = [
   ...
   {
      img: 'https://picsum.photos/id/13/300/300',
      name: 'theanh28entertainment',
      realName: 'Theanh28 Entertainment',
      href: '#',
   },
   {
      img: 'https://picsum.photos/id/16/300/300',
      name: 'vietphuongthoa98',
      realName: 'Việt Phương Thoa',
      href: '#',
   },
   {
      img: 'https://picsum.photos/id/34/300/300',
      name: 'hoaa',
      realName: 'Đào Lê Phương Hoa',
      href: '#',
   },
];
...
const DiscoverItem = ({ href, icon, name }: { href: string; icon: string | string[]; name: string }) => {
   return (
      <li className="discover-item">
         <a href={href} className="discover-link">
            {typeof icon === 'string' ? <b>{icon}</b> : <i className={icon.join(' ')} />}
            <span>{name}</span>
         </a>
      </li>
   );
         ...
         <div className={cx('side-scroll')}>
            <div className="sidebar ">
               <div className="nav-wrapper">
                  <a href="123" className="nav-item active">
                     <svg
                        className="nav-icon"
                        width="40"
                        height="40"
                     ...
                     <h3 className="nav-name">For you</h3>
                  </a>
                  <a href="#123" className="nav-item">
                     <svg
                        className="jsx-3696278927 nav-icon"
                        width="40"
                        height="40"
                        viewBox="0 0 48 48"
                        fill="#161823"
                     ...
                     <h3 className="nav-name">Following</h3>
                  </a>
                  <a href="#123" className="nav-item">
                     <svg
                        className="jsx-3696278927 nav-icon"
                     ...
                     <h3 className="nav-name">LIVE</h3>
                  </a>
               </div>
               <div className="user-list">
                  <div className="suggested-user-header">Suggested accounts</div>
                  {suggestedAccounts.map((acc, i) => {
                     return <Account key={i} {...acc} />;
                  })}
               ...
               <div className="user-list">
                  <div className="suggested-user-header">Following accounts</div>
                  <Account name="cciinnn" realName="CiiN" img="https://picsum.photos/id/39/300/300" />
                  <div className="user-more">
                     <p>See more</p>
                  </div>
               </div>
               <div className="discover-container">
                  ...
                  <ul className="discover-list">
                     <DiscoverItem href="#" name="anngonnaugon" icon="#" />
                     <DiscoverItem href="#" name="rapmaster2021" icon="#" />
                     <DiscoverItem href="#" name=" Buồn làm chi em ơi (remix) - AP" icon={['fab', 'fa-itunes-note']} />
                     <DiscoverItem href="#" name=" Laxed (Siren Beat) - Jawsh 685" icon={['fab', 'fa-itunes-note']} />
                     <DiscoverItem href="#" name=" Kelly Fake" icon={['fas', 'fa-search']} />
                     <DiscoverItem href="#" name=" dancemaster2021" icon="#" />
                  </ul>
               </div>
               <div className="footer-container">
                  {FooterList.map((footerItem, index) => {
                     return (
                        <a href={footerItem.link} key={index} className="footer-link">
                           {footerItem.name}
                        </a>
                     );
                  })}
